...
task HaplotypeCallerFromGatkPolyploid {  # TODO: We can use HaplotypeCaller and remove this one that came from gatk_polyploid.wdl
  input {
    File reference_fasta
    File reference_dict
    File reference_fai
...
task ImportGVCFsFromGatkPolyploid {  # TODO: We can use ImportGVCFs and remove this one that came from gatk_polyploid.wdl
  input {
    Array[File] vcfs
    Array[File] vcfs_index
    File reference_fasta
...
task GenotypeGVCFsFromGatkPolyploid {  # TODO: We can use GenotypeGVCFs and remove this one that came from gatk_polyploid.wdl
  input {
    File workspace_tar
    File reference_fasta
    File reference_fai
...
task MergeVCFsFromGatkPolyploid {  # TODO: We can use MergeVCFs and remove this one that came from gatk_polyploid.wdl
